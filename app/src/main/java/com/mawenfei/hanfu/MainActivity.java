...
import com.mawenfei.hanfu.activity.AddCommodityActivity;
import com.mawenfei.hanfu.activity.CommodityTypeActivity;
import com.mawenfei.hanfu.activity.PersonalCenterActivity;
import com.mawenfei.hanfu.activity.ReviewCommodityActivity;
import com.mawenfei.hanfu.adapter.AllCommodityAdapter;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        TextView tvAddHanfu = findViewById(R.id.tv_add_hanfu);
        //跳转到添加物品界面
        final Bundle bundle3 = new Bundle();
        tvAddHanfu.setOnClickListener(new View.OnClickListener() {
            @Override
...
//                Intent intent = new Intent(MainActivity.this, CommodityTypeActivity1.class);
